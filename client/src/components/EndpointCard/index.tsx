...
const LayerComponent: FunctionComponent<LayerProps> = props => {
  ...
  useEffect(() => {
    ...
    const currentHeight = layout.endpointHeight(endpointId);
    ...
    layout.setEndpointHeight(endpointId, newHeight);
  ...
  return (
    <g transform={`translate(${x}, ${y})`}>
      <foreignObject
        width={layout.endpointWidth(endpointId) + shadowSize}
...
export const EndpointCardContent: FunctionComponent<LayerProps> = props => {
  return (
    <EndpointCardLayer {...props}>
      <EndpointCardHeader endpoint={props.endpoint} />
