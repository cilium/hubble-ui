...
FROM --platform=${BUILDPLATFORM} docker.io/library/node:22.2.0-alpine3.20@sha256:3bb8914774985da457e08ca85654fecc062a206807d6225ede5b9b4e7465e733 as stage1
RUN apk add bash
WORKDIR /app
