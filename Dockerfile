...
FROM --platform=${BUILDPLATFORM} docker.io/library/node:23.7.0-alpine3.20@sha256:3ac002b133fd3737c44b66f0d023f5d75c7a1ddec71954fa06486aed6aead888 as stage1
RUN apk add bash
WORKDIR /app
