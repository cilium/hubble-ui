...
FROM --platform=${BUILDPLATFORM} docker.io/library/node:22.6.0-alpine3.20@sha256:4162c8a0f1fef9d3b003eb1fd3d8a26db46815288832aa453d829f4129d4dfd3 as stage1
RUN apk add bash
WORKDIR /app
