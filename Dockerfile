...
FROM --platform=${BUILDPLATFORM} docker.io/library/node:22.4.0-alpine3.20@sha256:1e847ddc61d073787aaca688e2a6568d77688b4eae561c806efeb39617caa53f as stage1
RUN apk add bash
WORKDIR /app
