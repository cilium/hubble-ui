...
FROM --platform=${BUILDPLATFORM} docker.io/library/node:22.4.1-alpine3.20@sha256:ba898e86c2cc720c8cf2ae05f8d2d4697fe0c8ca3e920d6fbf14a6cbf50bb9ca as stage1
RUN apk add bash
WORKDIR /app
