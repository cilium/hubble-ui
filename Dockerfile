...
# skopeo inspect --override-os linux --override-arch amd64 docker://docker.io/nginxinc/nginx-unprivileged:1.29-alpine3.23-slim | jq -r '.Digest'
FROM docker.io/nginxinc/nginx-unprivileged:1.29-alpine3.23-slim
USER root
