...
export interface Flow {
     ...
     * l3
     *
     * @generated from protobuf field: flow.IP IP = 5
     */
    iP?: IP;
    /**
     * l4
    ...
    /**
     * @generated from protobuf field: flow.FlowType Type = 10
     */
    type: FlowType;
    /**
     ...
     *
     * @deprecated
     * @generated from protobuf field: string Summary = 100000 [deprecated = true]
     */
    summary: string;
    /**
...
export interface Layer4 {
    ...
    protocol: {
        oneofKind: "tCP";
        /**
         * @generated from protobuf field: flow.TCP TCP = 1
         */
        tCP: TCP;
    } | {
        oneofKind: "uDP";
        /**
         * @generated from protobuf field: flow.UDP UDP = 2
         */
        uDP: UDP;
    } | {
        oneofKind: "iCMPv4";
         ...
         *
         * @generated from protobuf field: flow.ICMPv4 ICMPv4 = 3
         */
        iCMPv4: ICMPv4;
    } | {
        oneofKind: "iCMPv6";
        /**
         * @generated from protobuf field: flow.ICMPv6 ICMPv6 = 4
         */
        iCMPv6: ICMPv6;
    } | {
        oneofKind: "sCTP";
...
export interface TCPFlags {
    /**
     * @generated from protobuf field: bool FIN = 1
     */
    fIN: boolean;
    /**
     * @generated from protobuf field: bool SYN = 2
     */
    sYN: boolean;
    /**
     * @generated from protobuf field: bool RST = 3
     */
    rST: boolean;
    /**
     * @generated from protobuf field: bool PSH = 4
     */
    pSH: boolean;
    /**
     * @generated from protobuf field: bool ACK = 5
     */
    aCK: boolean;
    /**
     * @generated from protobuf field: bool URG = 6
     */
    uRG: boolean;
    /**
     * @generated from protobuf field: bool ECE = 7
     */
    eCE: boolean;
    /**
     * @generated from protobuf field: bool CWR = 8
     */
    cWR: boolean;
    /**
     * @generated from protobuf field: bool NS = 9
     */
    nS: boolean;
}
/**
...
export enum TraceObservationPoint {
     ...
     *
     * @generated from protobuf enum value: FROM_CRYPTO = 12;
     */
    FROM_CRYPTO = 12,
    /**
     ...
     *
     * @generated from protobuf enum value: TO_CRYPTO = 13;
     */
    TO_CRYPTO = 13
}
/**
...
class Flow$Type extends MessageType<Flow> {
    constructor() {
        super("flow.Flow", [
            ...
            { no: 32, name: "socket_cookie", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 33, name: "cgroup_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 socket_cookie */ 32:
                    message.socketCookie = reader.uint64().toBigInt();
                    break;
                case /* uint64 cgroup_id */ 33:
                    message.cgroupId = reader.uint64().toBigInt();
                    break;
                case /* string Summary = 100000 [deprecated = true] */ 100000:
...
class Layer7$Type extends MessageType<Layer7> {
    constructor() {
        super("flow.Layer7", [
            ...
            { no: 2, name: "latency_ns", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
...
class Endpoint$Type extends MessageType<Endpoint> {
    constructor() {
        super("flow.Endpoint", [
            ...
            { no: 6, name: "workloads", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Workload }
        ]);
    }
...
class FlowFilter$Type extends MessageType<FlowFilter> {
    constructor() {
        super("flow.FlowFilter", [
            ...
            { no: 26, name: "source_workload", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Workload },
            ...
            { no: 27, name: "destination_workload", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Workload },
            ...
            { no: 35, name: "interface", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => NetworkInterface },
            { no: 6, name: "event_type", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => EventTypeFilter },
            ...
            { no: 32, name: "http_header", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HTTPHeader },
            { no: 23, name: "tcp_flags", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TCPFlags },
...
class HTTP$Type extends MessageType<HTTP> {
    constructor() {
        super("flow.HTTP", [
            ...
            { no: 5, name: "headers", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HTTPHeader }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 num_events_lost */ 2:
                    message.numEventsLost = reader.uint64().toBigInt();
                    break;
...
class PolicyUpdateNotification$Type extends MessageType<PolicyUpdateNotification> {
    constructor() {
        super("flow.PolicyUpdateNotification", [
            ...
            { no: 2, name: "revision", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "rule_count", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
class ServiceUpsertNotification$Type extends MessageType<ServiceUpsertNotification> {
    constructor() {
        super("flow.ServiceUpsertNotification", [
            ...
            { no: 3, name: "backend_addresses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ServiceUpsertNotificationAddr },
