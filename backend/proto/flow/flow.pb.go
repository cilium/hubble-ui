...
var file_flow_flow_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x63, 0x65, 0x2a, 0x2f, 0x0a, 0x08, 0x46, 0x6c, 0x6f, 0x77, 0x54, 0x79, 0x70, 0x65,
	...
	0x02, 0x4c, 0x37, 0x10, 0x02, 0x2a, 0xea, 0x01, 0x0a, 0x15, 0x54, 0x72, 0x61, 0x63, 0x65, 0x4f,
	...
	0x76, 0x34, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x49, 0x50, 0x76, 0x36, 0x10, 0x02, 0x2a, 0x45,
	...
	0x52, 0x4f, 0x52, 0x10, 0x03, 0x2a, 0x4a, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x66, 0x66, 0x69, 0x63,
	...
	0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x4c, 0x6f, 0x73, 0x74, 0x10, 0x02, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_flow_flow_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
...
var file_flow_flow_proto_goTypes = []interface{}{
	...
	(*Flow)(nil),                // 7: flow.Flow
	(*Layer4)(nil),              // 8: flow.Layer4
	(*Layer7)(nil),              // 9: flow.Layer7
	(*Endpoint)(nil),            // 10: flow.Endpoint
	(*TCP)(nil),                 // 11: flow.TCP
	(*IP)(nil),                  // 12: flow.IP
	(*Ethernet)(nil),            // 13: flow.Ethernet
	(*TCPFlags)(nil),            // 14: flow.TCPFlags
	(*UDP)(nil),                 // 15: flow.UDP
	(*ICMPv4)(nil),              // 16: flow.ICMPv4
	(*ICMPv6)(nil),              // 17: flow.ICMPv6
	(*EventTypeFilter)(nil),     // 18: flow.EventTypeFilter
	(*CiliumEventType)(nil),     // 19: flow.CiliumEventType
	(*FlowFilter)(nil),          // 20: flow.FlowFilter
	(*Payload)(nil),             // 21: flow.Payload
	(*DNS)(nil),                 // 22: flow.DNS
	(*HTTPHeader)(nil),          // 23: flow.HTTPHeader
	(*HTTP)(nil),                // 24: flow.HTTP
	(*Kafka)(nil),               // 25: flow.Kafka
	(*Service)(nil),             // 26: flow.Service
	(*timestamp.Timestamp)(nil), // 27: google.protobuf.Timestamp
}
var file_flow_flow_proto_depIdxs = []int32{
	27, // 0: flow.Flow.time:type_name -> google.protobuf.Timestamp
	4,  // 1: flow.Flow.verdict:type_name -> flow.Verdict
	13, // 2: flow.Flow.ethernet:type_name -> flow.Ethernet
	12, // 3: flow.Flow.IP:type_name -> flow.IP
	8,  // 4: flow.Flow.l4:type_name -> flow.Layer4
	10, // 5: flow.Flow.source:type_name -> flow.Endpoint
	10, // 6: flow.Flow.destination:type_name -> flow.Endpoint
	0,  // 7: flow.Flow.Type:type_name -> flow.FlowType
	9,  // 8: flow.Flow.l7:type_name -> flow.Layer7
	19, // 9: flow.Flow.event_type:type_name -> flow.CiliumEventType
	26, // 10: flow.Flow.source_service:type_name -> flow.Service
	26, // 11: flow.Flow.destination_service:type_name -> flow.Service
	...
	11, // 14: flow.Layer4.TCP:type_name -> flow.TCP
	15, // 15: flow.Layer4.UDP:type_name -> flow.UDP
	16, // 16: flow.Layer4.ICMPv4:type_name -> flow.ICMPv4
	17, // 17: flow.Layer4.ICMPv6:type_name -> flow.ICMPv6
	2,  // 18: flow.Layer7.type:type_name -> flow.L7FlowType
	22, // 19: flow.Layer7.dns:type_name -> flow.DNS
	24, // 20: flow.Layer7.http:type_name -> flow.HTTP
	25, // 21: flow.Layer7.kafka:type_name -> flow.Kafka
	14, // 22: flow.TCP.flags:type_name -> flow.TCPFlags
	3,  // 23: flow.IP.ipVersion:type_name -> flow.IPVersion
	4,  // 24: flow.FlowFilter.verdict:type_name -> flow.Verdict
	18, // 25: flow.FlowFilter.event_type:type_name -> flow.EventTypeFilter
	6,  // 26: flow.Payload.type:type_name -> flow.EventType
	27, // 27: flow.Payload.time:type_name -> google.protobuf.Timestamp
	23, // 28: flow.HTTP.headers:type_name -> flow.HTTPHeader
